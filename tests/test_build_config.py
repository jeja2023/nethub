...
class BuildConfigTests(unittest.TestCase):
    ...
    def test_vless_security_none_does_not_enable_tls(self) -> None:
        cfg = build_singbox_config([
            "vless://00000000-0000-0000-0000-000000000000@example.com:80?type=tcp&security=none#plain"
        ])
    ...
    def test_vless_reality_enables_tls(self) -> None:
        cfg = build_singbox_config([
            "vless://00000000-0000-0000-0000-000000000000@example.com:443?type=tcp&security=reality&pbk=abc&sid=def#reality"
        ])
